...
namespace ISFDyT124.Migrations
{
    ...
    [Migration("20260617181401_ArregloDefinitivo")]
    partial class ArregloDefinitivo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarreraMateriaUsuario", b =>
                {
                    ...
                    b.ToTable("CarreraMateriaUsuario");
                });
            ...
            modelBuilder.Entity("ISFDyT124.Models.Usuario", b =>
                {
                    ...
                    b.Property<int?>("CarreraCohorteCaCoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CarreraCohorteCaCoId");
            ...
            modelBuilder.Entity("ISFDyT124.Models.Usuario", b =>
                {
                    b.HasOne("ISFDyT124.Models.CarreraCohorte", "CarreraCohorte")
                        .WithMany("Usuarios")
                        .HasForeignKey("CarreraCohorteCaCoId");
