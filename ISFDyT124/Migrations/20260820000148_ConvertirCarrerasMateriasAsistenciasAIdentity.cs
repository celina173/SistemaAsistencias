...
namespace ISFDyT124.Migrations
{
    ...
    public partial class ConvertirCarrerasMateriasAsistenciasAIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // las constraints. Los nombres de FK son los que crea AgregarInscripcionesYCarrerasMaterias
            // (FK_CarreraMateria_...) — la base compartida tenía estas mismas constraints con el
            // nombre "FK_CarrerasMaterias_..." por un drift manual fuera de las migraciones,
            // razón por la que esta migración fallaba al reproducirla contra una base 100% nueva
            // (ticket 6.2).
            migrationBuilder.Sql(@"
                ALTER TABLE Asistencias DROP CONSTRAINT FK_Asistencias_Materias_MaId;
                ALTER TABLE CarreraMateria DROP CONSTRAINT FK_CarreraMateria_Materias_MaId;
                ...
                ALTER TABLE CarreraMateria ADD CONSTRAINT FK_CarreraMateria_Materias_MaId FOREIGN KEY (MaId) REFERENCES Materias(MaId) ON DELETE CASCADE;
            ");

            migrationBuilder.Sql(@"
                ALTER TABLE CarreraCohortes DROP CONSTRAINT FK_CarreraCohortes_Carreras_CaId;
                ALTER TABLE CarreraMateria DROP CONSTRAINT FK_CarreraMateria_Carreras_CaId;
                ...
                ALTER TABLE CarreraMateria ADD CONSTRAINT FK_CarreraMateria_Carreras_CaId FOREIGN KEY (CaId) REFERENCES Carreras(CaId) ON DELETE CASCADE;
            ");
